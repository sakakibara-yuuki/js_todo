...
class TodoItem extends EventTarget {
  ...
  onSave() {
    ...
    this.todoItemView
      .querySelector("input.todo-label")
      .replaceWith(this.todoLabel);
  }
...
class TodoList extends EventTarget {
  ...
  onProgress() {
    ...
    this.progressView.querySelector(".js-total").textContent =
      `Total: ${total}`;
    this.progressView.querySelector(".js-done").textContent =
      `Done: ${checkedItems}`;
    this.progressView.querySelector(".js-doing").textContent =
      `Doing: ${uncheckedItems}`;
  }
